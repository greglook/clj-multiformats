...
(defn- pom-template
  ...
  [version-tag]
  [[:description "Clojure(Script) implementations of the self-describing multiformat specs."]
   [:url "https://github.com/greglook/clj-multiformats"]
   [:licenses
    [:license
     [:name "Public Domain"]
   ...
   [:scm
    [:url "https://github.com/greglook/clj-multiformats"]
    [:connection "scm:git:https://github.com/greglook/clj-multiformats.git"]
    [:developerConnection "scm:git:ssh://git@github.com/greglook/clj-multiformats.git"]
    [:tag version-tag]]])
